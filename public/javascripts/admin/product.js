...
ArticleSearch.create = function() { 
    ...
    {keys: ['description','name', 'tags'], show: ['query'],       hide: ['categories', 'button']},
...
var ProductForm = {
  changeImage: function() {
		$F(this) ? $('product_image_uploaded_image').show() : $('product_image_uploaded_image').hide();
  }
}

Event.addBehavior({
	'#change_product_image': function() {Event.observe(this, 'change', ProductForm.changeImage.bind(this));}
})